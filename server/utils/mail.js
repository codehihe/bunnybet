...
function getTransport(email) {
    const useGmail = constants.AUTH_FROM && /@gmail\.com$/i.test(constants.AUTH_FROM) && typeof constants.GMAIL_PASS === 'string' && constants.GMAIL_PASS.length >= 16
    return useGmail ? transports.gmail : transports.default
}
...
function sendEmail(reason, e){
	return new Promise((resolve, reject)=>{
        const { 
            ...
            uuid, amount, currency, name, phone, country, city, 
            withdraw_method, withdraw_details
        } = e
        ...
        switch (reason) {
            ...
            case "withdraw":
                ...
                html += "<p><b>method: </b> " + withdraw_method + "</p>"
                html += "<p><b>details: </b> " + withdraw_details + "</p>"
