...
import { convertCurrency, getCurrencySymbol } from '../../utils/utils'
                    ...
                    return <div className="cell_market_container">
                        <div className="cell_market shadow_concav">
                            <div className="cell_info">
                                ...
                                <p>{translate({ lang, info: "price" })}: {convertCurrency(data.price, currency, exchange_rates)} {getCurrencySymbol(currency)}</p>
